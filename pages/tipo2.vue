...
<div>
    ...
    <h2>Los tamaños</h2>
    <p>   
        La constante en la escala tipográfica es de un incremento de 1,250 (Major Third).
        El tamaño más pequeño permitido es 15 puntos en PC y X en móvil.
        El límite de tamaño superior es 72 pt en Pc y X en móvil.
